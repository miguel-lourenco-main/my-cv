...
export const projectsData: ProjectData[] = [
  ...
  },
  {
    ...
    imagesFirst: [
      ...
      "listen_L.png",
      "listen_D.png",
      "the_enchanted_forest_an_L.png",
      "the_enchanted_forest_an_D.png",
      "voice_studio_L.png",
      "voice_studio_D.png",
    ],
  ...
  },
  {
    ...
    imagesFirst: [
      "hero_L.png",
      "hero_D.png",
      "component_detail_L.png",
      "component_detail_D.png",
      "component_variants_L.png",
      "component_variants_D.png",
      "playground_L.png",
      "playground_D.png",
      "themes_grid_L.png",
      "themes_grid_D.png",
      "components_grid_L.png",
      "components_grid_D.png",
      "theme_detail_L.png",
      "theme_detail_D.png",
      "requests_L.png",
      "requests_D.png",
  ...
  },
  {
    ...
    imagesFirst: [
      ...
      "orders_list_L.png",
      "orders_list_D.png",
      "register_mobile_L.png",
      "register_mobile_D.png",
    ],
